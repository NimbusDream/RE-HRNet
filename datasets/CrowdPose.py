...
class CrowdPoseDataset(Dataset):
    """
    CrowdPoseDataset class.
    """

    def __init__(self,
                 root_path="./datasets/crowdpose", image_path="images", data_version="train", is_train=True, use_gt_bboxes=True, bbox_path="",
        ...
        """
        Initializes a new CrowdPoseDataset object.
        ...
        Args:
            ...
            soft_nms (bool): enable soft non-maximum suppression.
                Default: False
        """
        super(CrowdPoseDataset, self).__init__()
        ...
        self.data_path = os.path.join(self.root_path, self.image_path)
        self.annotation_path = os.path.join(
            self.root_path, 'annotations', 'crowdpose_%s.json' % self.data_version
        )
        ...
        print("!!!!!imgIds len:", len(self.imgIds))
        ...
        for imgId in tqdm(self.imgIds):
            ...
            for obj in objs:
                ...
                self.data.append({
                    'imgId': imgId,
                    'annId': obj['id'],
                    'imgPath': os.path.join(self.root_path, self.image_path, '%d.jpg' % imgId),
                    'center': center,
                    'scale': scale,
                    'joints': joints,
...
if __name__ == '__main__':
    crowdpose = CrowdPoseDataset(rotate_prob=0., half_body_prob=0.)
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!")
    item = crowdpose.__getitem__(0)
    print('ok!!')
